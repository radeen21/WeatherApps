...
import com.example.weatherapps.databinding.FragmentSplashBinding
import com.example.weatherapps.di.Injectable
import com.example.weatherapps.utils.extensions.hide
import com.example.weatherapps.utils.extensions.show
...
class SplashFragment : BaseFragment<SplashFragmentViewModel, FragmentSplashBinding>(R.layout.fragment_splash, SplashFragmentViewModel::class.java),
    ...
    override fun init() {
        ...
        if (binding.viewModel?.sharedPreferences?.getString(Constant.Coords.LON, "").isNullOrEmpty()) {
